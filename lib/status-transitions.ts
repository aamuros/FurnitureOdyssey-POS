...
export const orderStatusTransitions = {
  ...
  SCHEDULED_FOR_DELIVERY: ["CONFIRMED", "PARTIALLY_PAID", "PAID", "PARTIALLY_DELIVERED", "DELIVERED", "CANCELLED"],
...
export const orderDeliveryStatusTransitions = {
  ...
  SCHEDULED: ["NOT_SCHEDULED", "PARTIALLY_DELIVERED", "DELIVERED", "CANCELLED"],
  PARTIALLY_DELIVERED: ["DELIVERED", "CANCELLED"],
  DELIVERED: [],
  CANCELLED: []
...
export const deliveryStatusTransitions = {
  ...
  SCHEDULED: ["IN_TRANSIT", "PARTIALLY_DELIVERED", "DELIVERED", "CANCELLED"],
  IN_TRANSIT: ["PARTIALLY_DELIVERED", "DELIVERED", "CANCELLED", "FAILED"],
  PARTIALLY_DELIVERED: ["DELIVERED", "CANCELLED"],
  DELIVERED: [],
  FAILED: ["SCHEDULED"],
  CANCELLED: []
