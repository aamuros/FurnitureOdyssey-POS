  ...
  return (
    <button
      className={cn(
        ...
        variant === "secondary" &&
          "border border-border bg-soft-accent/70 text-foreground hover:bg-soft-accent",
        variant === "ghost" && "text-foreground hover:bg-muted/60",
        variant === "danger" && "border border-danger/30 bg-danger text-white hover:bg-danger/90",
        className
      )}
      {...props}
    />
